...
void M3508_MainTask(M3508_TypeDef* M) {
	...
	M->vel[0] = M->vel[0] * 0.5f + (float)M->velocity[0] / 60.f * 0.5f;
	M->vel[1] = M->vel[1] * 0.5f + (float)M->velocity[1] / 60.f * 0.5f;
	M->vel[2] = M->vel[2] * 0.5f + (float)M->velocity[2] / 60.f * 0.5f;
	M->vel[3] = M->vel[3] * 0.5f + (float)M->velocity[3] / 60.f * 0.5f;
